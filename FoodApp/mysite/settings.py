...
SECRET_KEY = 'django-insecure-d-^fsmu(9&7vbj25$ii3t(*hgahq@^on%)^fv=u7bi5)q^(cs^'
...
LOGIN_URL = 'login'
MEDIA_ROOT = os.path.join(BASE_DIR, 'mysite_PFP')
MEDIA_URL = '/mysite_PFP/'